...
const Spiritual = ({navigation, route}) => {
  const {uid} = route.params;
  const [pilihanSpiritual, setPilihanSpiritual] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanSpiritual: pilihanSpiritual,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Spiritual"
          value={pilihanSpiritual}
          onChangeText={value => setPilihanSpiritual(value)}

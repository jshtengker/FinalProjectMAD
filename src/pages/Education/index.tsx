...
const Education = ({navigation, route}) => {
  ...
  const [pilihanEducation, setPilihanEducation] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanEducation: pilihanEducation,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Education"
          value={pilihanEducation}
          onChangeText={value => setPilihanEducation(value)}

...
const Parlementary = ({navigation, route}) => {
  const {uid} = route.params;
    const [pilihanParlementary, setPilihanParlementary] = useState('')
  
    const onSubmit = () => {
      const data = {
        pilihanParlementary: pilihanParlementary,
      }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Parlementary"
          value={pilihanParlementary}
          onChangeText={value => setPilihanParlementary(value)}

...
const VicePresident = ({navigation, route}) => {
  const {uid} = route.params;
  const [pilihanWakilPresiden, setPilihanWakilPresiden] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanWakilPresiden: pilihanWakilPresiden,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Wakil Presiden"
          value={pilihanWakilPresiden}
          onChangeText={value => setPilihanWakilPresiden(value)}

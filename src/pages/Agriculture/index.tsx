...
const Agriculture = ({navigation, route}) => {
  const {uid} = route.params;
  const [pilihanAgriculture, setPilihanAgriculture] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanAgriculture: pilihanAgriculture,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Agriculture"
          value={pilihanAgriculture}
          onChangeText={value => setPilihanAgriculture(value)}

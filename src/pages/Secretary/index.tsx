...
const Secretary = ({navigation, route}) => {
  ...
  const [pilihanSecretary, setPilihanSecretary] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanSecretary: pilihanSecretary,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Secretary"
          value={pilihanSecretary}
          onChangeText={value => setPilihanSecretary(value)}

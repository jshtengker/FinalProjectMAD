...
const PublicRelation = ({navigation, route}) => {
  const {uid} = route.params;
  const [pilihanPublicRelation, setPilihanPublicRelation] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanPublicRelation: pilihanPublicRelation,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Public Relation"
          value={pilihanPublicRelation}
          onChangeText={value => setPilihanPublicRelation(value)}

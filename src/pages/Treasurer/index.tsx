...
const Treasurer = ({navigation, route}) => {
  const {uid} = route.params;
  const [pilihanTreasurer, setPilihanTreasurer] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanTreasurer: pilihanTreasurer,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          ...
          value={pilihanTreasurer}
          onChangeText={value => setPilihanTreasurer(value)}

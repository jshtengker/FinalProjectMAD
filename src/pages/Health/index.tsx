...
const Health = ({navigation, route}) => {
  ...
  const [pilihanHealth, setPilihanHealth] = useState('')

  const onSubmit = () => {
    const data = {
      pilihanHealth: pilihanHealth,
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
          label="Nama Kandidat"
          placeholder="Masukkan nama kandidat Health"
          value={pilihanHealth}
          onChangeText={value => setPilihanHealth(value)}
